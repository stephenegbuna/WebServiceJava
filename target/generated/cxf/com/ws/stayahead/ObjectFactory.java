 ...
 * generated in the com.ws.stayahead package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://stayahead.ws.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://stayahead.ws.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://stayahead.ws.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://stayahead.ws.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.stayahead
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://stayahead.ws.com/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://stayahead.ws.com/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://stayahead.ws.com/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://stayahead.ws.com/", name = "createOrdersResponse")
