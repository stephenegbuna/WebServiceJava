 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calcservice/", wsdlLocation = "http://localhost:9999/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calcservice/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calcservice/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calcservice/", "CalculatorPort"), Calculator.class, features);
    }
