...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://calcservice/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://calcservice/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://calcservice/", "multiply");
    private final static QName _Add_QNAME = new QName("http://calcservice/", "add");
    private final static QName _Subtract_QNAME = new QName("http://calcservice/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://calcservice/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://calcservice/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://calcservice/", "multiplyResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calcservice/", name = "multiplyResponse")
